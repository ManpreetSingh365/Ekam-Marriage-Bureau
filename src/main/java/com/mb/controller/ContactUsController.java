...
public class ContactUsController {
	...
	public RedirectView processSendContactUsQuery(
		...
		if (contactEmail == null || contactEmail.equals("Not Mentioned") || contactEmail.trim().isEmpty()) {
			Message msg = Message.builder().content("Email is required to submit your Message!").type(MessageType.red)
					.build();
...
//			return "index#rsvp";
		...
		String message = ""
				...
				+ "  </div>" + "  <div style='background: #f9f9f9; padding: 15px;'>"
				...
				+ "        <tr><td style='padding: 5px 0;'><strong>&#128100; Name:</strong></td><td style='padding: 5px 0;'>"
				+ contactName + "</td></tr>"
				+ "        <tr><td style='padding: 5px 0;'><strong>&#128231; Email:</strong></td><td style='padding: 5px 0;'>"
				+ contactEmail + "</td></tr>"
				+ "        <tr><td style='padding: 5px 0;'><strong>&#128222; Phone Number:</strong></td><td style='padding: 5px 0;'>"
				+ contactNumber + "</td></tr>"
				+ "        <tr><td style='padding: 5px 0;'><strong>&#9998; Filled By:</strong></td><td style='padding: 5px 0;'>"
				+ contactFormFilledBy + "</td></tr>"
				+ "        <tr><td style='padding: 5px 0;'><strong>&#128172; Message:</strong></td><td style='padding: 5px 0;'>"
				+ contactMessage + "</td></tr>" + "      </table>" + "    </div>"
				+ "    <div style='text-align: center; margin-top: 5px;'>" // This centers the button
				+ "      <a href='" + baseUrl
				+ "/findmatch' style='font-size: 16px; background-color: #e47a2e; padding: 12px 30px; color: white; text-decoration: none; border-radius: 50px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); display: inline-block; transition: all 0.3s ease;'>"
				+ "        Visit Ekam Marriage Bureau" + "      </a>" + "    </div>"
				...
				+ "  </div>" + "  <div style='background: #333; padding: 15px; text-align: center;'>"
				+ "    <p style='color: #fff; font-size: 12px; margin: 0;'>© 2024 Ekam Marriage Bureau. All Rights Reserved.</p>"
				+ "    <p style='color: #aaa; font-size: 10px; margin: 5px 0 0;'>For inquiries, visit us at Chaura Bazaar, Mandir Wala Bazar, Gobind Nagar, Amritsar, Punjab, India or call <a href='tel:+91"
				+ mbNumber + "' style='color: #e47a2e;'>+91 " + mbNumber + "</a>.</p>" + "  </div>" + "</div>"
				+ "<style>" + "  @media (max-width: 480px) {" + "    h1 { font-size: 20px; }"
				+ "    h2 { font-size: 14px; }" + "    p, td { font-size: 12px; }"
				+ "    div, table { width: 100%; padding: 10px; }" + "  }" + "</style>";
		String to = ekamEmail;
